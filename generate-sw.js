...
const swContent = `const CACHE_NAME = 'muzik-v${cacheVersion}'
const PRECACHE_ASSETS = ${JSON.stringify(filesToCache, null, 2)}
...
console.log(`Generated sw.js with ${filesToCache.length} pre-cached assets (cache: muzik-v${cacheVersion})`)
